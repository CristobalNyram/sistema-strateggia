$(function () {
    ...
    function editableTable() {
        ...
        $('#table-edit_new').click(function (e) {
            ...
            /*Variable con botones de guardar: '<p class="text-center"><a class="edit btn btn-dark" href=""><i class="fa fa-pencil-square-o"></i>Edit</a> <a class="delete btn btn-danger" href=""><i class="fa fa-times-circle"></i> Remove</a></p>'*/
