                                    ...
                                    <div class="row" style="margin-bottom: 1em;">
                                        <div class="form-group">
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref1_nombre" id="ref1_nombre" type="text" class="form-control">
                                                    <input name="no_estudio" id="no_estudio" type="hidden" value="estudio8">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref1_telefono" id="ref1_telefono" type="text" class="form-control phone-inputmask">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref1_tiempo" id="ref1_tiempo" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref1_referencia" id="ref1_referencia" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom: 1em;">
                                        <div class="form-group">
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref2_nombre" id="ref2_nombre" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref2_telefono" id="ref2_telefono" type="text" class="form-control phone-inputmask">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref2_tiempo" id="ref2_tiempo" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref2_referencia" id="ref2_referencia" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-bottom: 1em;">
                                        <div class="form-group">
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref3_nombre" id="ref3_nombre" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref3_tiempo" id="ref3_tiempo" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <label class="form-label">
                                                ...
                                                <div class="controls" >
                                                    <input name="ref3_comentario" id="ref3_comentario" type="text" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    function validar()
{
        ...
        $.ajax(
        {
            ...
            success : function(data)
            {
                if(data == 1)
                {
                    window.location.replace("nuevo_estudio9.php");
                }
                else
                {
